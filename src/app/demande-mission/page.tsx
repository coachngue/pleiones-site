...
const DemandeMissionPage: React.FC = () => {
  return (
    <main className="bg-slate-50 text-slate-900">
      {/* HERO */}
      <section className="bg-gradient-to-r from-slate-800 to-slate-900 text-white">
        <div className="max-w-5xl mx-auto px-6 py-20 text-center">
          <h1 className="text-3xl md:text-4xl font-bold mb-4">Demande de mission</h1>
        ...
        <div className="max-w-4xl mx-auto px-6">
          ...
          >
            ...
            <div>
              ...
              <input type="text" name="organisation" required className="w-full mt-2 p-3 border rounded-lg" />
            </div>
            <div>
              <label className="font-medium">Pays de la mission</label>
              <input type="text" name="pays" required className="w-full mt-2 p-3 border rounded-lg" />
            </div>
            <div>
              <label className="font-medium">Type de mission</label>
              <select name="type_mission" required className="w-full mt-2 p-3 border rounded-lg">
            ...
            <div>
              ...
              <select name="budget" required className="w-full mt-2 p-3 border rounded-lg">
                <option value="">— Sélectionner —</option>
                <option>&lt; 5 000 €</option>
            ...
            <div>
              ...
              <textarea name="description" rows={5} required className="w-full mt-2 p-3 border rounded-lg" />
            </div>
            <div>
              <label className="font-medium">Email professionnel</label>
              <input type="email" name="email" required className="w-full mt-2 p-3 border rounded-lg" />
            </div>
            <div className="pt-6">
              <button type="submit" className="w-full bg-slate-900 text-white py-4 rounded-xl font-semibold hover:bg-slate-800 transition">
...
export default DemandeMissionPage;
